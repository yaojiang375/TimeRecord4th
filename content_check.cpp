...
{
    if(content[0]==globe.AddFlag[0]||content[0]==globe.RecFlag[0])
    {
...
int Content_Check::AddCheck(globeset globe, QString content)
{
    ...
    {
        QString a;
        a=content.mid(1,content.indexOf(globe.AddEndFlag)-1);
        content.remove(0,a.length()+2);
